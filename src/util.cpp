...
bool LogAcceptCategory(const char* category)
{
    if (category != NULL) {
        ...
        if (ptrCategory.get() == NULL) {
            ...
            if (ptrCategory->count(string("Ant7"))) {
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Ant7";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "ant7.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "ant7d.pid"));
