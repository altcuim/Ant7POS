...
// Copyright (c) 2017-2018 The Ant7 developers
                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    resize(1185, 735);
    QString windowTitle = tr("Ant7core") + " - ";
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Ant7 address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and ant7: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Ant7core"), this);
    aboutAction->setStatusTip(tr("Show information about Ant7core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Ant7"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Ant7 addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Ant7 addresses"));
    ...
    openAction->setStatusTip(tr("Open a Ant7: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Ant7core help message to get a list with possible Ant7 command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Ant7core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Ant7 network", "", count));
}
...
{
    QString strTitle = tr("Ant7core"); // default title
